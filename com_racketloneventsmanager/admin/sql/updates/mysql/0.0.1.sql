...
INSERT INTO
`#__racketloneventsmanager` (`name`, `type`, `link`, `notes`, `singles`, `doubles`, `startdate`, `enddate`, `location`, `postcode`, `teams`, `dated`, `year`)
VALUES
('Test event 1', 'International', 'www.racketlon.co.uk', 'Some notes', TRUE, FALSE, '2016-04-03', '2016-04-03', 'Oxford', 'OX5 2BB', TRUE, TRUE, '2016'),
