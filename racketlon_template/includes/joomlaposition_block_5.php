...
function joomlaposition_block_5($caption, $content, $classes = '', $id = '', $extraClass = '')
{
    ...
    ob_start();
    ?>
    <div class=" bd-block-6 <?php echo $classes; ?>" <?php echo $id; ?>>
...
<?php endif; ?>
    ...
    <div class="bd-container-47 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-inputs bd-custom-bulletlist bd-custom-orderedlist bd-custom-table<?php echo $extraClass;?>">
