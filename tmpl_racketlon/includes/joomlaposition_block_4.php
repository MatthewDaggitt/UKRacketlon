...
<?php endif; ?>
    ...
    <div class="bd-container-45 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-inputs bd-custom-bulletlist bd-custom-orderedlist bd-custom-table<?php echo $extraClass;?>">
